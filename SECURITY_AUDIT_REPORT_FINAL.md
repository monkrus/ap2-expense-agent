...
**Evidence**: Org billing routes and usage tracking

- Marketplace entitlement required for billing-sensitive operations when `ENABLE_GCP_MARKETPLACE=true`
- Usage tracking enforces active/trialing `OrganizationSubscription`
- Organization creation is blocked outside Marketplace provisioning

**Configuration**: `backend/src/billing/usage_tracker.py`, `backend/src/billing/limit_enforcer.py`, `backend/src/routes/organizations.py`
