...
By accessing or using AP2 Expense Management Agent ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the Service.

## 2. Description of Service

AP2 Expense Management Agent is a cloud-based expense management application that provides:

- Expense submission and tracking
- AP2 protocol compliance (Intent, Cart, Payment mandates)
...
- **Organization Owner**: Billing and subscription management
...
- Legitimate business expense management
- Tracking and reporting expenses in your organization
- Compliance with your organization's expense policies
- Activities that comply with all applicable laws
...
- Submit fraudulent or false expense claims
...
- Free trials are subject to availability
- No credit card required for Free plan
- Trial converts to paid plan unless canceled
...
- You retain all rights to your expense data
...
- See Privacy Policy for security details

### 6.3 Data Retention

- Data is retained while your account is active
- After deletion, data is retained for 90 days in backups
- You can export your data at any time
- Some data may be retained for legal compliance

### 6.4 Data Processing

- We process data in accordance with GDPR and CCPA
- Data Processing Agreement available upon request
- EU-US Privacy Shield compliant (if applicable)
...
"AP2 Expense Management Agent" and related logos are our trademarks. You may not use them without permission.

### 7.3 Your Content

- You retain ownership of your expense data
- You grant us a license to use your content to provide the Service
- We may use anonymized, aggregated data for analytics and improvements
...
- Service may be unavailable for maintenance
...
You agree to indemnify and hold us harmless from any claims, damages, liabilities, and expenses (including legal fees) arising from:

- Your use of the Service
- Your violation of these Terms
- Your violation of any rights of others
- Your expense submissions or content
...
- No refunds for unused time in billing period
- Export your data before cancellation
- Deletion takes effect at end of billing period
...
Material changes take effect 30 days after notification. Continued use constitutes acceptance.
...
**Arbitration**: Any disputes will be resolved through binding arbitration, not in court, except:
...
Residents of certain jurisdictions may have additional rights that cannot be waived.

## 16. AP2 Protocol Compliance

### 16.1 Three-Mandate System

The Service implements the AP2 protocol with three mandates:
...
- Complete audit trail for all expense operations
- Timestamps for all three mandates
- Immutable records for compliance
- Export available for auditing purposes

## 17. Service Level Agreement (SLA)

### 17.1 Uptime Guarantee

**Professional and Enterprise plans**:
- 99.9% uptime guarantee
- Monthly uptime calculation excludes scheduled maintenance
...
**Free and Starter**: Email support, 48-hour response
**Professional**: Email + chat support, 24-hour response
**Enterprise**: Priority support, dedicated account manager, 4-hour response

## 18. Export Control

You agree to comply with all export laws and restrictions. You will not export or re-export the Service to prohibited countries or individuals.
...
By using AP2 Expense Management Agent, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
