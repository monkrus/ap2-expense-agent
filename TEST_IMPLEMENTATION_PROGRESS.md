...
- `backend/tests/test_gcp_*` - Marketplace entitlement tests (status varies)
...
### 3. Marketplace Billing Enforcement Tests



**Priority**: CRITICAL

**Test Coverage**: Marketplace entitlements, usage reporting, and gating



- `backend/tests/test_gcp_marketplace_client.py`

- `backend/tests/test_gcp_webhooks_auth.py`

- `backend/tests/test_gcp_procurement.py`

- Add org usage limit unit tests for `backend/src/billing/limit_enforcer.py`
...
**Total Lines of Test Code Added**: ~2,600+ lines (excluding removed tier limit suite)
