...
import { DollarSign, TrendingUp, AlertTriangle, CheckCircle, Plus, Edit2, Trash2, Eye, Filter } from 'lucide-react';
...
const BudgetManagement = () => {
  ...
  const fetchBudgets = async () => {
    try {
      ...
      const response = await fetch(`/api/budgets?active_only=${showActiveOnly}`, {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Monitor and manage organizational budgets</p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between text-sm">
                <span className="text-green-600">{stats.on_track} On Track</span>
                <span className="text-yellow-600">{stats.warning} Warning</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-orange-600">{stats.critical} Critical</span>
