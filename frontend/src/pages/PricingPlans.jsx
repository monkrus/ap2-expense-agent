...
const PRICING_TIERS = [
  {
    ...
    description:
      "Get started with basic expense tracking. No credit card required, free forever.",
    highlights: ["Quick setup", "Basic expense tracking", "Mobile friendly"],
    icon: Zap,
    color: "gray",
  ...
  },
  {
    ...
    description:
      "Perfect for freelancers and small teams who want to simplify expense tracking without the complexity.",
  ...
  },
  {
    ...
    description:
      "Ideal for growing businesses that need automation, advanced analytics, and seamless integrations.",
    highlights: [
      "Unlimited expenses",
