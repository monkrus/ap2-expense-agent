...
const UpgradeBanner = ({
  ...
  const variants = {
    upgrade: {
      ...
      subtitle: 'Get unlimited expenses, AI categorization, and priority support.',
    ...
    promo: {
      ...
      subtitle: promoCode ? `Use code ${promoCode} at checkout.` : 'Limited time offer.',
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="hidden sm:inline text-white/90 ml-2">{v.subtitle}</span>
          </div>
        </div>
...
export const SidebarUpgradeCard = ({ userPlan = 'Free', className = '' }) => {
  ...
  return (
    <div className={`bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 rounded-xl p-4 ${className}`}>
