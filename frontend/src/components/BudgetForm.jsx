...
const BudgetForm = ({ budget, onSuccess, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (parseInt(formData.critical_threshold) <= parseInt(formData.warning_threshold)) {
    ...
    try {
      ...
      showSuccess(isEditing ? 'Budget updated successfully' : 'Budget created successfully');
      onSuccess(data);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* Scope */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Budget Scope</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Leave blank for all categories</p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Leave blank for all users</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Alert when spending reaches this %</p>
              </div>
            ...
            {parseInt(formData.critical_threshold) <= parseInt(formData.warning_threshold) && (
          ...
          <div className="flex items-center gap-3 pt-4 border-t">
            ...
            <button
              type="submit"
              disabled={loading || (parseInt(formData.critical_threshold) <= parseInt(formData.warning_threshold))}
