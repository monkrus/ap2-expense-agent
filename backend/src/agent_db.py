...
from .repository import ExpenseRepository, AP2Repository
...
class ExpenseManagementAgent:
    ...
    def __init__(self, db: Session, api_key: str = "", project_id: str = "", organization_id: Optional[str] = None):
    ...
    def submit_expense(
        ...
        category_enum = ExpenseCategory[category.upper().replace(" ", "_")] if hasattr(ExpenseCategory, category.upper().replace(" ", "_")) else ExpenseCategory.OTHER
    ...
    def approve_and_process_expense(
        self,
        expense_id: str,
        approver_id: str
    ) -> Dict:
        ...
        self.expense_repo.update(expense.id, {
    ...
    def get_expense_report(self, user_id: Optional[str] = None) -> Dict:
        ...
        expenses = self.expense_repo.get_by_user(user_id) if user_id else self.expense_repo.get_all()
