...
class TestExpenseAPIRoutes:
    ...
    def test_get_expenses_with_pagination(self, client, auth_headers):
        ...
        response = client.get("/api/v1/expenses?skip=0&limit=10", headers=auth_headers)

        assert response.status_code == 200

    def test_get_expenses_with_status_filter(self, client, auth_headers):
        """Test filtering expenses by status"""
        response = client.get("/api/v1/expenses?status=PENDING", headers=auth_headers)
    ...
    def test_get_nonexistent_expense(self, client, auth_headers):
        ...
        response = client.get("/api/v1/expenses/nonexistent_id", headers=auth_headers)
    ...
    def test_delete_nonexistent_expense(self, client, auth_headers):
        ...
        response = client.delete(
            "/api/v1/expenses/nonexistent_id", headers=auth_headers
        )
    ...
    def test_export_expenses(self, client, auth_headers):
        ...
        response = client.get(
            "/api/v1/expenses/export?format=csv", headers=auth_headers
        )
    ...
    def test_get_expense_statistics(self, client, auth_headers):
        ...
        response = client.get("/api/v1/expenses/stats", headers=auth_headers)
...
class TestExpenseCommentsAPI:
    ...
    def test_get_expense_comments(self, client, auth_headers, test_expense):
        ...
        response = client.get(
            f"/api/v1/expenses/{test_expense.id}/comments", headers=auth_headers
        )
...
class TestReceiptAPI:
    ...
    def test_upload_receipt_invalid_file_type(self, client, auth_headers, test_expense):
    ...
    def test_get_expense_receipts(self, client, auth_headers, test_expense):
        ...
        response = client.get(
            f"/api/v1/expenses/{test_expense.id}/receipts", headers=auth_headers
        )
