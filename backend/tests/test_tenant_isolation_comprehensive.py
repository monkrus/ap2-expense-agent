...
class TestCrossOrgDataLeakage:
    ...
    def test_SEC_ISO_001_user_cannot_view_other_org_expense(
        ...
        response = client.get(
            f"/api/v1/expenses/{org1_expense.id}",
            headers=headers
        )
    ...
    def test_SEC_ISO_002_invalid_organization_header_blocked(
        self, client, db_session
    ):
        """
        Test ID: SEC-ISO-002
        ...
        response = client.get(
            f"/api/v1/expenses/{org2_expense.id}",
            headers=headers
        )
    ...
    def test_SEC_ISO_003_cannot_update_other_org_expense(
        self, client, db_session
    ):
        """
        Test ID: SEC-ISO-003
    ...
    def test_SEC_ISO_004_sql_injection_organization_filter(
        self, client, db_session
    ):
        """
        Test ID: SEC-ISO-004
    ...
    def test_SEC_ISO_005_soft_deleted_org_data_invisible(
        self, client, db_session
    ):
        """
        Test ID: SEC-ISO-005
        ...
        org, owner = create_organization_with_owner(db_session, org_name="To Be Deleted")
    ...
    def test_SEC_ISO_006_soft_deleted_member_access_denied(
        self, client, db_session
    ):
        """
        Test ID: SEC-ISO-006
    ...
    def test_SEC_ISO_007_list_expenses_filtered_by_org(
        self, client, db_session
    ):
        """
        Test ID: SEC-ISO-007
    ...
    def test_SEC_ISO_008_cannot_list_other_org_members(
        self, client, db_session
    ):
        """
        Test ID: SEC-ISO-008
    ...
    def test_SEC_ISO_009_missing_organization_header_rejected(
        self, client, db_session
    ):
        """
        Test ID: SEC-ISO-009
