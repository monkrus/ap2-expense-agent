...
def main():
    ...
    print("=" * 60)
    print(
        f"Test 1 - Accept Valid Request:     {'✅ PASS' if test1_pass else '❌ FAIL'}"
    )
    print(
        f"Test 2 - Deny Amount Exceeded:     {'✅ PASS' if test2_pass else '❌ FAIL'}"
    )
    print(
        f"Test 3 - Deny Category Mismatch:   {'✅ PASS' if test3_pass else '❌ FAIL'}"
    )
    print("=" * 60)
