...
class AP2TestSuite:
    ...
    def login(
        self, username: str = "employee1", password: str = "Password123!"
    ) -> bool:
    ...
    def test_1_1_create_basic_intent_mandate(self):
        ...
        try:
            ...
            self.log_test(
                "1. Intent Mandate Creation", "1.1 Create Basic Mandate", False, str(e)
            )
    ...
    def test_1_2_multiple_merchants(self):
        ...
        try:
            ...
            self.log_test(
                "1. Intent Mandate Creation", "1.2 Multiple Merchants", False, str(e)
            )
            return None
    ...
    def test_1_3_multiple_categories(self):
        ...
        try:
            ...
            self.log_test(
                "1. Intent Mandate Creation", "1.3 Multiple Categories", False, str(e)
            )
            return None
    ...
    def test_2_1_list_mandates(self):
        ...
        try:
            response = requests.get(
                f"{BASE_URL}/api/ap2/user/mandates", headers=self.get_headers()
            )
    ...
    def test_3_1_basic_auto_approval(self, mandate_id: str):
        ...
        if not mandate_id:
            self.log_test(
                "3. Auto-Approval", "3.1 Basic Auto-Approval", False, "No mandate ID"
            )
            return None
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                checks = {
                    ...
                    "via_intent_mandate": data.get("auto_approved_via")
                    == "intent_mandate",
                ...
                self.log_test(
                    "3. Auto-Approval", "3.1 Basic Auto-Approval", all_passed, details
                )
                return data.get("id")
            else:
                self.log_test(
                    "3. Auto-Approval",
                    "3.1 Basic Auto-Approval",
                    False,
    ...
    def test_3_3_amount_exceeds_limit(self):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                passed = data.get("status") == "PENDING" and not data.get(
                    "auto_approved"
                )
                self.log_test(
                    "3. Auto-Approval",
    ...
    def test_3_4_wrong_category(self):
        ...
        try:
            ...
            mandate_payload = {
                "constraints": {"max_amount": 100.00, "category": "OFFICE_SUPPLIES"},
                "expiration": (datetime.now() + timedelta(hours=1)).isoformat(),
            }
    ...
    def test_5_5_combined_constraints(self):
        ...
        try:
            ...
            self.log_test(
                "5. Constraint Matching", "5.5 Combined Constraints", False, str(e)
            )
    ...
    def test_7_1_complete_flow(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test(
                    "7. Complete AP2 Flow", "7.1 Complete Flow", all_passed, details
                )
            else:
                self.log_test(
                    "7. Complete AP2 Flow",
    ...
    def test_10_5_usage_stats(self):
        ...
        try:
            response = requests.get(
                f"{BASE_URL}/api/ap2/stats", headers=self.get_headers()
            )
    ...
    def test_12_3_duplicate_prevention(self):
        ...
        try:
            ...
            passed = (
                response1.status_code in [200, 201] and response2.status_code == 409
            )
            self.log_test(
                "12. Error Handling",
            ...
            self.log_test(
                "12. Error Handling", "12.3 Duplicate Prevention", False, str(e)
            )
